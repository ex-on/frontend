      ...
      builder: (context) {
        return SafeArea(
          child: SmartRefresher(
            controller: controller.dailyStatsRefreshController,
            onRefresh: controller.onDailyStatsRefresh,
                                    ...
                                    builder: (_) {
                                      return Column(
                                        ...
                                        children: () {
                                          ...
                                          _.dailyExerciseStatData['records']
                                              .asMap()
                                              .forEach(
                                            (index, record) {
                                              if (record['sets'] != null) {
                                                children.add(
                                                  DailyExerciseStatWeightBlock(
                                                      index: index),
                                                );
                                              } else {
                                                children.add(
                                                  DailyExerciseStatCardioBlock(
                                                      index: index),
                                                );
                                              }
                                            },
