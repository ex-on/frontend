    ...
    return Builder(builder: (context) {
      return SafeArea(
        child: SmartRefresher(
          controller: controller.monthlyStatsRefreshController,
          onRefresh: controller.onMonthlyStatsRefresh,
                    ...
                    if (_.loading) {
                      ...
                      previousWeeklyList.asMap().forEach((index, val) {
                        previousWeeklyData.add([
                          (index + 1).toString() + '주',
                          previousWeeklyList[index][
                              monthlyStatsCategoryIntToStrEng[
                                  _.monthlyStatsByWeekCategory]]
                        ]);
                      });
                      ...
                      if (_.monthlyExerciseStatData['category_stats']
                              ['weight'] !=
                          null) {
                      ...
                      if (_.monthlyExerciseStatData['category_stats']
                        ...
                        piChartValuesLength += 1;
                        piChartValuesSum +=
                            _.monthlyExerciseStatData['category_stats']
                                ['cardio'] as int;
                      ...
                      List<PieChartSectionData> _generatePiChartData() {
                        return List.generate(
                          ...
                          (i) {
                            ...
                            if (piChartValuesLength !=
                                    targetMuscleList.length &&
                            ...
                            return PieChartSectionData(
                              color:
                                  targetMuscleIntToColor[targetMuscleList[i]],
                              value: piChartValuesList[i].toDouble(),
                              ...
                              children: [
                                ...
                                Row(
                                  children: const [
                                    ...
                                    Padding(
                                      padding:
                                          EdgeInsets.only(left: 3, right: 8),
                                      child: Text(
                                        '이번달',
                                        style: TextStyle(
                                          fontSize: 10,
                                  ...
                                  if (index % 2 == 0) {
                                    ...
                                    if (idx == _.monthlyStatsByWeekCategory) {
                                      return ElevatedButton(
                                        onPressed: () =>
                                            _onMonthlyStatsCategoryButtonPressed(
                                                idx),
