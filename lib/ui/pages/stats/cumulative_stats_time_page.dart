  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration.zero, () {
      if (controller.cumulativeTimeStatData.isEmpty) {
        controller.cumulativeTimeStatsRefreshController.requestRefresh();
      }
    });
    ...
    return GetBuilder<StatsController>(
      builder: (_) {
        return SmartRefresher(
          controller: controller.cumulativeTimeStatsRefreshController,
          onRefresh: controller.onCumulativeTimeStatsRefresh,
          ...
          child: ListView(
            ...
            children: () {
              if (_.cumulativeTimeStatData.isEmpty || _.loading) {
                ...
                _.cumulativeTimeStatData['exercise_time_stat']
                    .forEach((key, val) {
                ...
                return [
                  ...
                  Padding(
                    ...
                    child: _.cumulativeTimeStatData['cumulative_stat']
                                ['num_stats'] ==
                            0
                        ? Column(
                            children: const [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        exerciseTimeStatData.isEmpty
                            ...
                            : SfCartesianChart(
                                // zoomPanBehavior:
                                //     _.cumulativeTimeStatsZoomPanBehavior,
                                ...
                                primaryYAxis: NumericAxis(
                                  ...
                                  axisLabelFormatter:
                                      (AxisLabelRenderDetails args) {
                                    String label = args.value % 60 == 0
                                        ? formatTimeToText(args.value as int)
                                        : '';
                                    return ChartAxisLabel(
                                      label,
                                      const TextStyle(
                                ...
                                trackballBehavior:
                                    _.cumulativeTimeStatsTrackballBehavior,
                                series: <ChartSeries>[
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: _.cumulativeTimeStatData['physical_stat']
                                        [0] ==
                                    0
